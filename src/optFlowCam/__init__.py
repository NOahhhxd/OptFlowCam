...
def register():
    ...
    """
    lib_path = os.path.join(os.path.dirname(__file__), "movPy")
    if lib_path not in sys.path:
        sys.path.insert(0, lib_path)
    """
    """
    ...
    lib_path = os.path.join(os.path.dirname(__file__), "proglog")
    if lib_path not in sys.path:
        sys.path.insert(0, lib_path)
    lib_path = os.path.join(os.path.dirname(__file__), "tqdm")
    if lib_path not in sys.path:
        sys.path.insert(0, lib_path)
    """
